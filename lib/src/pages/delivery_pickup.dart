            ...
            Column(
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: Text(
                      _con.carts.isNotEmpty ? 'ማሳሰቢያ' : '',
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                          color: Colors.orange.withOpacity(0.6), fontSize: 15),
                    )),
                Padding(
                    padding: const EdgeInsets.only(
                        top: 5, bottom: 0, left: 20, right: 10),
                    child: Text(
                      // S
                      //     .of(context)
                      //     .click_to_confirm_your_address_and_pay_or_long_press,
                      _con.carts.isNotEmpty
                          ? 'ከታች የሚመለከቱት ዋጋ ዴሊቨሪን አያካትትም የዴሊቨሪ ዋጋ ከ 0km እስከ 3km 30 ብር እንዲሁም 3km እስከ 6km  50 ብር መሆኑን እንገልፃለን። '
                          : '',
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: Theme.of(context).textTheme.caption,
                ...
                Padding(
                    padding: const EdgeInsets.only(
                        top: 10, bottom: 0, left: 20, right: 10),
                    child: Text(
                      _con.carts.isNotEmpty ? 'ATTENTION' : '',
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                          color: Colors.orange.withOpacity(0.6), fontSize: 15),
                ...
                Padding(
                    ...
                    child: Text(
                      _con.carts.isNotEmpty
                          ? 'Price you see below does not include delivery fee. Delivery from 0km - 3km costs 30 birr and from 3km - 6km costs 50birr.'
                          : '',
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: Theme.of(context).textTheme.caption,
